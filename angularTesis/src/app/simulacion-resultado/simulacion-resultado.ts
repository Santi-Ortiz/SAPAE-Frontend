...
export class SimulacionResultado implements OnInit {
  ...
  public volverFormSimulacion(): void { this.router.navigate(["/simulacion"]); }
  ...
  public guardarSimulacion(): void {
    ...
    this.historialSimulacionesService.guardarSimulacion(
      this.nombreSimulacion, this.resultadoSimulacion, parametrosSimulacion, this.jobIdActual || undefined
    );
